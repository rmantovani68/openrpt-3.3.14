...
public:
    ...
    {
        ReportParameter->setWindowTitle(QApplication::translate("ReportParameter", "Parameter", nullptr));
        _lblName->setText(QApplication::translate("ReportParameter", "Name:", nullptr));
        _lblType->setText(QApplication::translate("ReportParameter", "Type:", nullptr));
        _cbType->setItemText(0, QApplication::translate("ReportParameter", "String", nullptr));
        _cbType->setItemText(1, QApplication::translate("ReportParameter", "Integer", nullptr));
        _cbType->setItemText(2, QApplication::translate("ReportParameter", "Double", nullptr));
        _cbType->setItemText(3, QApplication::translate("ReportParameter", "Bool", nullptr));

        _active->setText(QApplication::translate("ReportParameter", "Active", nullptr));
        _lblDefault->setText(QApplication::translate("ReportParameter", "Default:", nullptr));
        _btnOk->setText(QApplication::translate("ReportParameter", "&OK", nullptr));
        _btnCancel->setText(QApplication::translate("ReportParameter", "&Cancel", nullptr));
        _tab->setTabText(_tab->indexOf(description), QApplication::translate("ReportParameter", "Description", nullptr));
        _listType->setTitle(QApplication::translate("ReportParameter", "List Type", nullptr));
        _staticList->setText(QApplication::translate("ReportParameter", "Static", nullptr));
        _dynamicList->setText(QApplication::translate("ReportParameter", "Dynamic", nullptr));
        _lblStatic->setText(QApplication::translate("ReportParameter", "Static List Values:", nullptr));
        QTreeWidgetItem *___qtreewidgetitem = _listValues->headerItem();
        ___qtreewidgetitem->setText(1, QApplication::translate("ReportParameter", "Label", nullptr));
        ___qtreewidgetitem->setText(0, QApplication::translate("ReportParameter", "Value", nullptr));
        _add->setText(QApplication::translate("ReportParameter", "Add", nullptr));
        _edit->setText(QApplication::translate("ReportParameter", "Edit", nullptr));
        _remove->setText(QApplication::translate("ReportParameter", "Remove", nullptr));
        _lblDynamic->setText(QApplication::translate("ReportParameter", "Dynamic List Query:", nullptr));
        _tab->setTabText(_tab->indexOf(lists), QApplication::translate("ReportParameter", "Defined List", nullptr));
    } // retranslateUi
