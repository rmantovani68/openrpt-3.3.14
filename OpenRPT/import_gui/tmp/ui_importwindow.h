...
public:
    ...
    {
        ImportWindow->setWindowTitle(QApplication::translate("ImportWindow", "Report Import Tool", nullptr));
        ...
        groupBox1->setTitle(QApplication::translate("ImportWindow", "Reports", nullptr));
