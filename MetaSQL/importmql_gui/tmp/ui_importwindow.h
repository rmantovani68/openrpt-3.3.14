...
public:
    ...
    {
        ImportWindow->setWindowTitle(QApplication::translate("ImportWindow", "MetaSQL Import Tool", nullptr));
        helpContentsAction->setText(QApplication::translate("ImportWindow", "&Contents...", nullptr));
        helpContentsAction->setIconText(QApplication::translate("ImportWindow", "Contents", nullptr));
#ifndef QT_NO_SHORTCUT
        helpContentsAction->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        helpIndexAction->setText(QApplication::translate("ImportWindow", "&Index...", nullptr));
        helpIndexAction->setIconText(QApplication::translate("ImportWindow", "Index", nullptr));
#ifndef QT_NO_SHORTCUT
        helpIndexAction->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        helpAboutAction->setText(QApplication::translate("ImportWindow", "&About", nullptr));
        helpAboutAction->setIconText(QApplication::translate("ImportWindow", "About", nullptr));
#ifndef QT_NO_SHORTCUT
        helpAboutAction->setShortcut(QString());
#endif // QT_NO_SHORTCUT
        fileExitAction->setText(QApplication::translate("ImportWindow", "E&xit", nullptr));
        fileExitAction->setIconText(QApplication::translate("ImportWindow", "E&xit", nullptr));
        fileOpenAction->setText(QApplication::translate("ImportWindow", "&Add", nullptr));
        fileOpenAction->setIconText(QApplication::translate("ImportWindow", "&Add", nullptr));
        _schemaLit->setText(QApplication::translate("ImportWindow", "Import into schema:", nullptr));
        groupBox1->setTitle(QApplication::translate("ImportWindow", "MetaSQL Files", nullptr));
        _add->setText(QApplication::translate("ImportWindow", "&Add", nullptr));
#ifndef QT_NO_SHORTCUT
        _add->setShortcut(QApplication::translate("ImportWindow", "Alt+A", nullptr));
#endif // QT_NO_SHORTCUT
        _remove->setText(QApplication::translate("ImportWindow", "Remove", nullptr));
        _import->setText(QApplication::translate("ImportWindow", "&Import", nullptr));
#ifndef QT_NO_SHORTCUT
        _import->setShortcut(QApplication::translate("ImportWindow", "Alt+I", nullptr));
#endif // QT_NO_SHORTCUT
        _selectAll->setText(QApplication::translate("ImportWindow", "Select All", nullptr));
        groupBox2->setTitle(QApplication::translate("ImportWindow", "Messages", nullptr));
        unnamed->setTitle(QApplication::translate("ImportWindow", "&File", nullptr));
        helpMenu->setTitle(QApplication::translate("ImportWindow", "&Help", nullptr));
    } // retranslateUi
