...
public:
    ...
    {
        SelectMQL->setWindowTitle(QApplication::translate("SelectMQL", "Choose a MetaSQL Query", nullptr));
        _schemaLit->setText(QApplication::translate("SelectMQL", "Schema or Package:", nullptr));
    } // retranslateUi
