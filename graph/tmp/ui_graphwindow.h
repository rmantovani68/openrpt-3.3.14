...
public:
    ...
    {
        GraphWindow->setWindowTitle(QApplication::translate("GraphWindow", "Graph Window", nullptr));
        _gbLabel->setTitle(QApplication::translate("GraphWindow", "Labels", nullptr));
        _dataLabel->setText(QApplication::translate("GraphWindow", "Data:", nullptr));
        _titleLabel->setText(QApplication::translate("GraphWindow", "Title:", nullptr));
        _valueLabel->setText(QApplication::translate("GraphWindow", "Value:", nullptr));
        _gbPadding->setTitle(QApplication::translate("GraphWindow", "Padding (in pixels)", nullptr));
        _vPadLabel->setText(QApplication::translate("GraphWindow", "Vertical:", nullptr));
        _hPadLabel->setText(QApplication::translate("GraphWindow", "Horizontal:", nullptr));
        _gbValueRange->setTitle(QApplication::translate("GraphWindow", "Value Range", nullptr));
        _maxValueLabel->setText(QApplication::translate("GraphWindow", "Max:", nullptr));
        _minValueLabel->setText(QApplication::translate("GraphWindow", "Min:", nullptr));
        _btnClear->setText(QApplication::translate("GraphWindow", "Clear All", nullptr));
        _styleGroup->setTitle(QApplication::translate("GraphWindow", "Graph Style", nullptr));
        _cbBars->setText(QApplication::translate("GraphWindow", "Bars", nullptr));
        _cbLines->setText(QApplication::translate("GraphWindow", "Lines", nullptr));
        _cbPoints->setText(QApplication::translate("GraphWindow", "Points", nullptr));
        _numSetLabel->setText(QApplication::translate("GraphWindow", "Number of Sets:", nullptr));
        _numRefLabel->setText(QApplication::translate("GraphWindow", "Number of References:", nullptr));
        QTableWidgetItem *___qtablewidgetitem = _labelTable->horizontalHeaderItem(0);
        ___qtablewidgetitem->setText(QApplication::translate("GraphWindow", "Label", nullptr));
        _gbSql->setTitle(QApplication::translate("GraphWindow", "Populate with SQL", nullptr));
        _btnSql->setText(QApplication::translate("GraphWindow", "Execute", nullptr));
    } // retranslateUi
